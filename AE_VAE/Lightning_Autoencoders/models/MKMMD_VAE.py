...
class Lit_MKMMD_VAE(pl.LightningModule):
    def __init__(self, learning_rate=0.0005, name='MKMMD_VAE',kernel_mul=2.0, kernel_num=5, fix_sigma=None):
    ...
    def training_step(self, batch, batch_idx):
        ...
        mkmmd_loss = self.mkmmd_loss_function(source=encoded, target=torch.randn_like(encoded, device=self.device))
        ...
        train_logs = {"combined_loss": combined_loss.detach(), "mse_loss": mse_loss.detach(), "mkmmd_loss": mkmmd_loss.detach()}
        # use key 'log'
    ...
    def validation_step(self, batch, batch_idx):
        ...
        validation_logs = {"combined_loss": combined_loss.detach(), "mse_loss": mse_loss.detach(), "mkmmd_loss":mkmmd_loss.detach()}
