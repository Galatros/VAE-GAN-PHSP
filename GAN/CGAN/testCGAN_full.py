...
outputFile = '/home/jakmic/Projekty/dose3d-phsp/GAN/CGAN/FakePhotonsFiles/fake.txt'
...
loadedGan.load_state_dict(torch.load('/home/jakmic/Projekty/dose3d-phsp/GAN/CGAN/Gen_' + modelFileName,map_location=torch.device(device)))
