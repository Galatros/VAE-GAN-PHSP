...
# Podaj ścieżke do configu i do do folderu z fake photons files
...
config_path= folder_path + '/config_001.json'
fake_photons_folder_path=folder_path+'/FakePhotonsFiles/'+checkpoint_file_name_without_extension
checkpoint_histograms_folder_path=folder_path+'/FakePhotonsHistograms/'+checkpoint_file_name_without_extension

fakePHSP_list = []
fakePHSP_E56_s00 = fake_photons_folder_path+'/fake_E5.6_s0.0_.txt'
fakePHSP_E56_s40 = fake_photons_folder_path+'/fake_E5.6_s4.0_.txt'
fakePHSP_E60_s20 = fake_photons_folder_path+'/fake_E6.0_s2.0_.txt'
fakePHSP_E64_s00 = fake_photons_folder_path+'/fake_E6.4_s0.0_.txt'
fakePHSP_E64_s40 = fake_photons_folder_path+'/fake_E5.6_s4.0_.txt'
...
evalreults_dict = {"name": f'{checkpoint_file_name_without_extension}/config_001.json'}
ks_2samp_dict = {}
...
for condition_key_index, condition_key_name in enumerate(conditions_keys):
    ...
    plt.savefig(
        f'{checkpoint_histograms_folder_path}/{condition_key_name}.png')
...
with open(checkpoint_histograms_folder_path+'/statistics_mse_ks2samp.json', 'w') as outfile:
...
plt.savefig(
    f'{checkpoint_histograms_folder_path}/ks2samp_log')
...
plt.savefig(
    f'{checkpoint_histograms_folder_path}/ks2samp')
...
plt.savefig(
    f'{checkpoint_histograms_folder_path}/ks2samp_log_summed')
fig = plt.figure()
ax = sns.heatmap(ks2samp_statistics_summed, xticklabels=xlabels)
ax.set_title('ks2samp_summed')
plt.savefig(
    f'{checkpoint_histograms_folder_path}/ks2samp_summed')
...
plt.savefig(
    f'{checkpoint_histograms_folder_path}/mse_log')
...
ax.set_title('mse')
plt.savefig(
    f'{checkpoint_histograms_folder_path}/mse')
...
plt.savefig(
    f'{checkpoint_histograms_folder_path}/mse_log_summed')
