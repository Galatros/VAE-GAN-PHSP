...
if __name__ == '__main__':
    # Hyperparameters
    CONFIG_PATH = '/home/jakmic/Projekty/dose3d-phsp/GAN/Lightning_GANs/configs/GAN.yaml'
    ...
    # model = gan_models[config['model_params']['name']](model_architecture, **config['model_params'])
